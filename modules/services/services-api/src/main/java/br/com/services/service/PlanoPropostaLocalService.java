...
/**
 * Provides the local service interface for PlanoProposta. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PlanoPropostaLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PlanoPropostaLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PlanoPropostaLocalServiceUtil} to access the plano proposta local service. Add custom service methods to <code>br.com.services.service.impl.PlanoPropostaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
